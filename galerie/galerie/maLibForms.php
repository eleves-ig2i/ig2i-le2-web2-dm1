...
// Produit un menu déroulant selon l'algorithme de mkSelect, avec un tableau non associatif et possibilité de choisir plusieurs options
function mkSelectNonAssociatif($nomChampSelect, $tabData)
{
